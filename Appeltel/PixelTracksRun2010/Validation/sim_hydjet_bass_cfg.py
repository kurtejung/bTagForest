...
ivars.register ('eventNumber',
                 1,
                ivars.multiplicity.singleton,
                ivars.varType.int,
                "Event number to record")
...
# Automatic addition of the customisation function from Configuration.GenProduction.customiseCaloDigisNZS
