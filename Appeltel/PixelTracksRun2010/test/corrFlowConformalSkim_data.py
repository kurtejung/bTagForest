...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string( 'file:skim_conformal_test.root')
)
...
process.hiGoodTracks.qualityBit = cms.string('tight')
process.hiGoodTracks.copyExtras = cms.untracked.bool(True)
