...
process.rechiCounter = cms.EDAnalyzer("RechitCount",
                              photonProducer = cms.InputTag("photons"),
                              ebAllRecHitCollection = cms.InputTag("ecalRecHit","EcalRecHitsEB"),
                              eeAllRecHitCollection = cms.InputTag("ecalRecHit","EcalRecHitsEE"),
