...
//---------------------------------------------------------------------------
class DumpHcalNoiseInformationFromRECO : public edm::EDAnalyzer
{
public:
   explicit DumpHcalNoiseInformationFromRECO(const edm::ParameterSet&);
   ~DumpHcalNoiseInformationFromRECO();
...
//---------------------------------------------------------------------------
DumpHcalNoiseInformationFromRECO::DumpHcalNoiseInformationFromRECO(const edm::ParameterSet& iConfig)
{
...
//---------------------------------------------------------------------------
DumpHcalNoiseInformationFromRECO::~DumpHcalNoiseInformationFromRECO()
{
}
//---------------------------------------------------------------------------
void DumpHcalNoiseInformationFromRECO::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
//---------------------------------------------------------------------------
void DumpHcalNoiseInformationFromRECO::beginJob()
{
...
//---------------------------------------------------------------------------
void DumpHcalNoiseInformationFromRECO::endJob() 
{
}
//---------------------------------------------------------------------------
void DumpHcalNoiseInformationFromRECO::beginRun(edm::Run const&, edm::EventSetup const&)
{
}
//---------------------------------------------------------------------------
void DumpHcalNoiseInformationFromRECO::endRun(edm::Run const&, edm::EventSetup const&)
{
}
//---------------------------------------------------------------------------
void DumpHcalNoiseInformationFromRECO::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
//---------------------------------------------------------------------------
void DumpHcalNoiseInformationFromRECO::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
//---------------------------------------------------------------------------
void DumpHcalNoiseInformationFromRECO::fillDescriptions(edm::ConfigurationDescriptions& descriptions)
{
...
//---------------------------------------------------------------------------
void DumpHcalNoiseInformationFromRECO::CleanUp()
{
   RunNumber = -1;
   EventNumber = -1;
   LumiSection = -1;
...
DEFINE_FWK_MODULE(DumpHcalNoiseInformationFromRECO);
