...
#process.load("HeavyIonsAnalysis.Configuration.Sources.Data2010_Run150476_Express_HLT_HIJet90U_cff")
...
process.GlobalTag.globaltag = 'GR_R_39X_V1::All'  #Data
...
process.load("HeavyIonsAnalysis.Configuration.HI_Jet90_OR_Photon30_Filter_cff")
process.load("HeavyIonsAnalysis.Configuration.HI_MBSkim_cff")

process.jetSkimPath = cms.Path(
    process.hltJetPhotonHI*
    process.hltMBHI
    )
