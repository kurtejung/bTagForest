...
process.hiHighPtTracksDontKeepAll = process.hiHighPtTracks.clone(keepAllTracks=False)
# Dpt/pt = 0.05
...
process.hiHighPtTrackSelection += process.hiHighPtTracksDontKeepAll
...
if useGoodTightCollection:
  ...
  #trkAnalyzer.trackSrc = 'hiHighPtTracks'
    hitrkEffAnalyzer_akpu3pf_j1.tracks = 'hiHighPtTracksDirectDontKeepAll'
    hitrkEffAnalyzer_akpu3pf_j2.tracks = 'hiHighPtTracksDirectDontKeepAll'
...
process.TFileService = cms.Service("TFileService",
                                   ...
                                   fileName=cms.string("JetAnalysisTTrees_hiGoodTightTracks_v4.root"))
