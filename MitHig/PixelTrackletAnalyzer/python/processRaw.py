...
process.reconstruct = cms.Path(process.mix*process.trackingParticles*process.siPixelDigis*process.pixeltrackerlocalreco*process.offlineBeamSpot*process.pixel3ProtoTracks*process.pixelVertices)
