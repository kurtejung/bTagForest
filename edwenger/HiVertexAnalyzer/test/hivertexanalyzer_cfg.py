...
process.load("edwenger.HiVertexAnalyzer.hivertexanalyzer_cfi")
process.load("edwenger.HiVertexAnalyzer.HiSelectedVertex_cfi")

# message logger
process.MessageLogger.categories = ['HiVertexAnalyzer']
